    ...
    <main>
      <section class="bg-white dark:bg-gray-900">
        ...
        >
          ...
          >
            Make your long links into short just in one click
          </p>
          <div
            class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4 mt-32"
          >
            <input
              type="url"
              id="url"
              class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2.5 w-full md:w-[60%]"
            />
            <button type="submit" class="bg-blue-600 text-white p-3 rounded-lg">
              Shorten this link!
            </button>
