    ...
    <main>
      <section class="bg-white dark:bg-gray-900">
        ...
        >
          ...
          <div
            class="flex flex-col mt-32 mb-8 space-y-4  lg:mb-16 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4"
          >
            <input
              type="url"
              id="url"
              ...
              "
            />
            <button type="submit" class="p-3 text-white bg-blue-600 rounded-lg">
              Shorten this link!
            </button>
